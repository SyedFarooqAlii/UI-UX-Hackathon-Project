...
<div className='flex'>
<div className="bg-gray-100 rounded-[10px] w-[100%] mt-4 lg:mt-0  py-4">
<div className="w-full max-w-[782px]  lg:w-[856px] bg-white px-4 sm:px-6 lg:px-8 rounded-lg ">
  {/* <!-- Billing Info --> */}
  ...
  <div className=' h-[0px] lg:h-[72px] lg:mt-0 mx-2 sm:pt-16'>
  ...
  <div className=' h-[0px] lg:h-[72px]  mt-2'>
    <div className=' hidden lg:block items-center justify-between'>
    ...
    <div className="mt-16 md:mt-4 lg:mt-4 sm:mt-12 px-1 pb-3 flex font-sans  justify-between gap-6 h-[70px]">
    <a href="#">
